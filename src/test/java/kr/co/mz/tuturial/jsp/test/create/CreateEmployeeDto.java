...
//  }
  ...
  public EmployeeDto nameMaster() {
    ...
    dto.setPhoneNumber("010-xxxx-xxxx");
    dto.setHireDate(Timestamp.valueOf(LocalDate.parse("2015-04-19").atStartOfDay()));
    dto.setDepartmentSeq(1);// todo department
    dto.setCreatedBy("admin");
    return dto;
  }
  ...
  public EmployeeDto nameBoss() {
    ...
    dto.setHireDate(Timestamp.valueOf(LocalDate.parse("1999-05-11").atStartOfDay()));
    dto.setDepartmentSeq(1);// todo department
    dto.setCreatedBy("admin");
    return dto;
  }
